...
public class Commission_List {
	...
	public void list() throws InterruptedException {
	    	...
	    	Thread.sleep(3000);
	    	WebElement Login=driver.findElement(By.xpath("//button[@class='fw btn btn-info btn-round btn-lg btn-block mb-3']"));
	    	Login.click();
	    	Thread.sleep(7000);
			...
			if (str1==str2) {
				...
				{
					tab1.click();
					WebElement card=driver.findElement(By.xpath("//div[@class='main-panel']//div[1]//div[1]//div[1]//div[2]"));
					card.getText();
					Thread.sleep(4000);
