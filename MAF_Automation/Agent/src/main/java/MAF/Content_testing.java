...
public class Content_testing {
	...
	public void content() throws InterruptedException {
		...
		String arry[] = {
				"Our mission is to provide all our agents with a quality work environment, as it allows everyone to make a more positive impact on the financial future of their clients. To ensure this, we have created a comprehensive support system for agents and their associates." };
		WebElement text = Maf_Base.getDriver()
				.findElement(By.xpath("/html/body/app-root/app-root/app-layout/section/app-home/div[2]/div/h3"));
	...
	public void compare() {
		...
		WebElement strvalue = Maf_Base.getDriver()
				.findElement(By.xpath("/html/body/app-root/app-root/app-layout/section/app-home/div[2]/div/h3"));
		// WebElement
		// strvalue1=Maf_Base.getDriver().findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-root[1]/app-layout[1]/section[1]/app-home[1]/div[3]/div[1]/div[3]/div[2]"));
