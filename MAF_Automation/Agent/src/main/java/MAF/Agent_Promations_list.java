...
public class Agent_Promations_list {
	...
	for(WebElement tab1:agentlist)
	{
		...
		Thread.sleep(10000);
		WebElement Agentpromat =driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-root[1]/app-agentlayout[1]/div[1]/div[1]/app-agenttasks[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/ngb-tabset[1]/ul[1]/li[2]/a[1]"));
		Agentpromat.click();
		Thread.sleep(5000);
		...
		WebElement Agentpromat2 =driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-root[1]/app-agentlayout[1]/div[1]/div[1]/app-agenttasks[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/ngb-tabset[1]/ul[1]/li[3]/a[1]"));
		Agentpromat2.click();
		Thread.sleep(5000);
...
//    	adminbutton.click();
    	...
    	Thread.sleep(3000);
    	WebElement adminlogin=driver.findElement(By.xpath("//button[@class='fw btn btn-info btn-round btn-lg btn-block mb-3']"));
    	adminlogin.click();
    	Thread.sleep(3000);
    	JavascriptExecutor jse = (JavascriptExecutor)driver;
    	jse.executeScript("document.body.style.zoom = '80%';");
    	Thread.sleep(8000);
    	WebElement AgentPromat=driver.findElement(By.xpath("//p[contains(text(),'Agent Promotions')]"));
    	AgentPromat.click();
		...
		//System.out.println("Agent promations: ");
		System.out.println("                                            ");
		System.out.println("Agent promations list: "+agentlist5.size());
