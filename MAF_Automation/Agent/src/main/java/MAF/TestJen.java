...
//	        driver.get("http://google.com");
	       ...
	       // driver.get(baseUrl);
	       // driver.findElement(By.cssSelector("body.sidebar-mini:nth-child(2) nav.navbar.navbar-expand-lg.bg-white div.container-fluid div.collapse.navbar-collapse.offset-4 ul.navbar-nav li.nav-item:nth-child(6) > a.nav-link")).sendKeys(Keys.CONTROL +"t");
