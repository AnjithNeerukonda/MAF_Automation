...
public class API_Cookie {
	...
	public void cokkie() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement admin_submit=driver.findElement(By.xpath("//button[@class='fw btn btn-info btn-round btn-lg btn-block mb-3']"));
        admin_submit.click();	
		Thread.sleep(3000);
	    ...
	    public static String getItemFromLocalStorage(String Value)
	    {
	        return (String) js.executeScript(String.format(
	            "return window.localStorage.getItem('adminIdToken');", Value)); 
	    }
	    @Test(priority=2)
